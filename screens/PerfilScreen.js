...
const PerfilScreen = () => {
  ...
  useEffect(() => {
    const cargarDatosUsuario = async () => {
      try {
        ...
        setUsuario({
          ...usuario,
          ced_usu: usuarioActual.ced_usu,
          nom_usu: usuarioActual.nom_usu,
          ape_usu: usuarioActual.ape_usu,
          cor_usu: usuarioActual.cor_usu,
          cel_usu: usuarioActual.cel_usu,
          ima_usu: usuarioActual.ima_usu,
          con_usu: usuarioActual.con_usu,
          conf_con_usu: usuarioActual.con_usu,
        });

        setCedula(usuarioActual.ced_usu);

        setCelular(usuarioActual.cel_usu);
  ...
  const handleSubmit = () => {
    ...
    updateUsuario(userId, usuarioConImagen);
  ...
  return (
    <View className="flex-1" style={{ backgroundColor: 'white', padding: 16, paddingTop: 40 }}>
      <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 16 }}>
        ...
        <Text style={{ color: themeColors.text, fontSize: 20, fontWeight: 'bold' }}>Perfil</Text>
      </View>
        ...
        <View style={{ backgroundColor: themeColors.bgDark, padding: 16, borderRadius: 8, shadowColor: themeColors.bgDark, shadowRadius: 10, shadowOffset: { width: 0, height: 5 }, shadowOpacity: 0.5 }}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            <TextInput
              ...
              editable={false}
              onChangeText={(text) => handleRegistrar('ced_usu', text.replace(/[^0-9]/g, ''))}
